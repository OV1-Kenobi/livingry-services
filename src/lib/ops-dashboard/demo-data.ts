...
export function demoApprovals(): ApprovalItem[] {
  return [
    ...
    { id: "apr_004", title: "Trigger review request on completed job", categoryId: "continuity", automationLevel: "A2_bounded_execute", requestedBy: "Continuity workflow", detail: "Job verified complaint-free by QC. Review invite queued to a consented customer.", status: "pending" },
...
export function demoLedger(): LedgerEntry[] {
  return [
    ...
    { id: "led_105", at: "2026-07-22T16:41:00-04:00", categoryId: "continuity", event: "Verified completion", action: "Review invite + maintenance reminder queued", automationLevel: "A2_bounded_execute", approvedBy: "Auto (within bounds)", outcome: "Invite delivered", proof: "sig:evt-22e7…4b" },
