...
export const faqSections: FaqSection[] = [
  {
    ...
    items: [
      ...
      { q: "Who are your ideal clients?", a: "Established U.S. HVAC/R companies are our active implementation focus. Roofing companies are a planned expansion once the Revenue Continuity System is battle-tested in HVAC." },
  ...
  },
  {
    ...
    items: [
      { q: "Do you only work with HVAC companies?", a: "HVAC/R is our active implementation focus — the vertical where our systems are built and battle-tested. Roofing is a planned expansion and is not yet enrolling." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Do you sign NDAs?", a: "Yes, routinely, before any baseline extraction or records review." },
