...
export const systemContents: Record<string, SystemContent> = {
  ...
  "customer-continuity": {
    ...
    lede: "The customers you already served are the cheapest, warmest, most honest opportunity you have. Customer Continuity Systems create relevant reasons to return, renew, refer, and act — while respecting the trust that made them a customer in the first place.",
    problem: [
      "Past customers only hear from you when something breaks.",
      "Seasonal maintenance opportunities go unused.",
      "Referrals happen in spite of you, not because of you.",
      "Reviews are inconsistent and untracked.",
    ...
    build: [
      ...
      { title: "Referral and review workflows",   body: "A calm, professional path from a satisfied customer to a review, referral, or reactivation — always opt-in, always human-approved." },
    ...
    outcomes: [
      "More repeat and referral revenue from the base you already serve.",
